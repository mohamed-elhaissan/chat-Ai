  ...
  return (
    <>
      <div className="flex justify-between items-center text-lg px-10 my-1">
        ...
        <div className="parentDiv cursor-pointer before:content-[''] before:absolute before:top-0 before:left-0 before:scale-0 before:bg-black before:w-full before:h-full before:rounded-full relative  w-[60px] h-[60px] rounded-full before:transition-all before:duration-200 before:ease-[cubic-bezier(0.16, 1, 0.3, 1)] hover:before:scale-100"
       >
          <span className="child block w-10  left-2 absolute top-5 z-20 h-[3px] transition-all duration-100 ease-in mb-1 rounded-full"></span>
          <span className="child block w-10  absolute left-2 bottom-5  z-20 h-[3px] transition-all duration-100 ease-in mb-1 rounded-full"></span>
        </div>
      </div>
      <hr></hr>
    </>
